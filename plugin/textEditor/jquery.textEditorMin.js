...
;(function(){
    ...
    Plugin.prototype.init=function(){
        ...
        pluginBox.off('click','#cbox-canvas').on('click','#cbox-canvas',function(e){
        ...
        pluginBox.off('touchstart touchmove touchend','#cbox-canvas').on('touchstart touchmove touchend','#cbox-canvas',function(event){
            if(event.type == "touchstart" ){
                ...
                if(move){
                    ...
                    $('#color-selected').css({'left':s_left+'px',top:s_top+'px','background':color});
                    $element.css('color',color);
                }
            }else{
                move=false;
    ...
    function initHtml(option){
        var cdiv = '';
        cdiv += '<div class="ted-ctrl"><div class="ted-ctrl-li ted-ctrl-base"><div class="ted-base-top">';
        cdiv += '<div class="base-top-group"><div class="base-top-font btn-group">';
        cdiv += '<button type="button" class="btn btn-default" class="ted-edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button>';
        cdiv += '</div><div class="base-top-align btn-group">';
        cdiv += '<button type="button" class="btn btn-default" class="ted-fontweight">B</button><button type="button" class="btn btn-default" id="ted-fontstyle">/</button>';
        cdiv += '<button type="button" class="btn btn-default" class="ted-underline">U</button></div></div>';
        cdiv += '<div class="base-top-group"><div class="base-top-font btn-group">';
        cdiv += '<button type="button" class="btn btn-default" class="ted-fontsizebig"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span></button>';
        cdiv += '<button type="button" class="btn btn-default" class="ted-fontsizesml"><span class="glyphicon glyphicon-zoom-out" aria-hidden="true"></span></button>';
        cdiv += '</div><div class="base-top-align btn-group">';
        cdiv += '<button type="button" class="btn btn-default" class="ted-leftalign"><span class="glyphicon glyphicon-align-left" aria-hidden="true"></span></button>';
        cdiv += '<button type="button" class="btn btn-default" class="ted-centeralign"><span class="glyphicon glyphicon-align-center" aria-hidden="true"></span></button>';
        cdiv += '<button type="button" class="btn btn-default" class="ted-rightalign"><span class="glyphicon glyphicon-align-right" aria-hidden="true"></span></button>';
        cdiv += '<button type="button" class="btn btn-default" class="ted-justify"><span class="glyphicon glyphicon-align-justify" aria-hidden="true"></span></button>';
        cdiv += '</div></div></div>';
        ...
        cdiv += '<div class="ted-ctrl-li ted-ctrl-color" class="ted-ctrl-color"><div class="ted-color-top"><ul class="color-list">';
        ...
        cdiv += '</ul></div><div class="ted-color-bot"><div class="bot-cbox"><div id="color-selected"></div><canvas id="cbox-canvas" width="800" height="200"></canvas></div></div></div>';
        cdiv += '<div class="ted-ctrl-li ted-ctrl-font"><div class="font-list"><ul>';
        ...
        cdiv += '</ul></div></div>';
        cdiv += '<div class="ted-ctrl-li ted-ctrl-effects">';
        ...
        cdiv += '<div class="ted-text-content"><div class="tt-cont-back"></div><div class="tt-cont-main"><div class="tt-cont-confirm"><span class="glyphicon glyphicon-ok"></span></div><textarea type="text" class="tt-content"></textarea></div></div>';
        return cdiv;
    }

    $.fn.tEdmin = function(option){
